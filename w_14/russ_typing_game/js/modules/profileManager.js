...
class ProfileManager
{
  ...
  create_profile_insert(el_id)
  {
    ...
    html += "<h2>Level " + this.user_data_obj.user_level + "</h2>";
    html += "<h3>" + this.get_player_title() + "</h3>";
  ...
  get_player_title()
  {
    let tmp_title = level_titles[this.user_data_obj.user_level];
    if(tmp_title == undefined)
    {
      tmp_title = "Undefinable by Mankind";
    }
    return tmp_title;
  }
  ...
  create_user_options_insert(el_id)
  {
    ...
    //stop background animation button
