                                   ...
                                   for(let j = st_y; j < end_y; j++)
                                   {
                                     ...
                                     if(tmp_px[3] != 0)
                                     {
                                       switch(action)
                                       {
                                         case "combine":
                                           //get alpha
                                           let tmp_ratio = tmp_px[4] / 255;
                                           let r = Math.round(tmp_ratio * tmp_px[0]) + self_px[0];
                                           let g = Math.round(tmp_ratio * tmp_px[1]) + self_px[1];
                                           let b = Math.round(tmp_ratio * tmp_px[2]) + self_px[2];
                                           //combine alpha?
                                           let a = tmp_px[4] + self_px[4];
                                           r %= 255;
                                           g %= 255;
                                           b %= 255;
                                           a %= 255;
