...
class UserStorage
{
  ...
  create_user(new_user_name)
  {
    ...
    this.curr_user = { user_name:       new_user_name,
                       user_list_names: ["a", "b", "c"],
                       user_lists:      ["text1", "text2", "text3"],//list text
                       high_scores:     [ 0, 100, 340],
                       last_scores:     [0, 20, 223],
                       high_score_game: ["game1", "game1", "game2"],
                       last_score_game: ["game2", "game2", "game2"],
                       user_level:      0,
                       user_xp:         0,
